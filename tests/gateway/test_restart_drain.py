...
def test_load_busy_input_mode_prefers_env_then_config_then_default(tmp_path, monkeypatch):
    ...
    (tmp_path / "config.yaml").write_text(
        "display:\n  busy_input_mode: integrated\n", encoding="utf-8"
    )
    assert gateway_run.GatewayRunner._load_busy_input_mode() == "integrated"
    ...
    monkeypatch.setenv("HERMES_GATEWAY_BUSY_INPUT_MODE", "integrated")
    assert gateway_run.GatewayRunner._load_busy_input_mode() == "integrated"
